...
-(CCAnimation*) animationForKey:(NSString*)key
{
    ...
    KITAssert2(animDict != nil, @"Called %@'s animationForKey: when object at key '%@' is not Dictionary. Check item.plist", itemId, key);
...
-(NSMutableArray*) loadSpriteFramesForKey:(NSString*)key dict:(NSDictionary*)dict
{
    ...
    // assertions
    KITAssert2(frameCount >= 1, @"The number 'sprites.%@.frameCount' is required in the plist for: %@", key, itemId);
    KITAssert2([format length] >= 1, @"The string 'sprites.%@.format' is required in the plist for: %@", key, itemId);
...
-(CCAnimation*) loadAnimationForKey:(NSString*)key dict:(NSDictionary*)dict
{
    ...
    // assertions
    KITAssert2(frameCount >= 1, @"The number 'animations.%@.frameCount' is required in the plist for: %@", key, itemId);
    KITAssert2([format length] >= 1, @"The string 'animations.%@.format' is required in the plist for: %@", key, itemId);
